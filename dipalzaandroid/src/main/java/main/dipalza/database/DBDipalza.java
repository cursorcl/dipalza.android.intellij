...
public class DBDipalza extends SQLiteOpenHelper {
	...
	String sqlCreateEspeciales = "CREATE TABLE Especiales (idProducto INTEGER PRIMARY KEY AUTOINCREMENT, articulo TEXT)";
	...
	String sqlCreateidxEspeciales = "CREATE INDEX idxProductos ON Especiales(idProducto ASC)";
	String sqlCreateidxEspecialesArticulo = "CREATE INDEX idxProductos ON Especiales(articulo ASC)";
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL(sqlCreateidxEspeciales);
	...
	public List<String> getEspeciales()
	{
    ...
    public void grabarEspecial(final String articulo) {
        ContentValues registro = new ContentValues();
        registro.put("articulo", articulo);
        db.insert(ESPECIAL, null, registro);
    }

    public void grabarEspecial(final List<String> articulos) {
        if(articulos == null || articulos.isEmpty())
            return;

        for(String articulo: articulos)
            grabarEspecial(articulo);
    }
